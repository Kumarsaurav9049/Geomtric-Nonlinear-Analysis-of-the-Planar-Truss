function not_used_nonlinear_function_file()
% Establish coordiantes and global dof's of nodes,
            ...
            fprintf('solving the standard example: %f \n',example)
                ...
                elseif example==3
                        ...
                        coordinate_xy_value_1 = (1.5+0.01*yy);
                        coordinate_xy_value_2 = (2+0.01*yy);
                        node = [ 1,  1,                          0,     2,   0 ;
                ...
                convergence_data =[];
                tolereance = input('Enter the Value up to What precision result is required (example : 10e-6) ')
                ...
                while convergence_criterion >= tolereance && iteration < max_iterations
                    ...
                    convergence_criterion = sqrt(sum(u_non.^2)/(sum(utemp.^2)))
                    utemp = u_non + utemp
